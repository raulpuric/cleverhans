...
from utils_cifar100 import data_mnist, model_mnist
...
def main(argv=None):
    ...
    x = K.placeholder(shape=(None, 3, 32, 32), dtype='float32')
    ...
    with h5.File('cifar_train_adv.h5','r') as f:
        X_train_adv=f['data']
    with h5.File('cifar_test_adv.h5','r') as f:
        X_test_adv=f['data']
